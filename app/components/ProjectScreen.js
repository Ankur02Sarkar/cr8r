            ...
            >
                <div
                    ...
                    onClick={() => {
                        ...
                        setTimeout(() => setProjectScreen({ id: -1, isOpen: false }), 250)
                    } // delay added to prevent 404 error showing during closing animation
                    }
                >
                    <MdClose />
                </div>
                {(data) ?
                    <>
                        ...
                        >
                            {data.link ? <a href={data.link} target="_blank" className="project-repo"><FaLink />Visit</a> : null}
                        </div>
