...
const FloatingMenu = ({ isOpen, setIsOpen, isDark, setIsDark }) => {
    ...
    return ( 
        <div className="menu-container" style={isOpen ? visible : null}>
            ...
            <a href="mailto:cr8r.freelance@gmail.com" style={{display: 'contents'}}><div className="menu-item" ><p>Contact</p></div></a>
            ...
            <a href="https://github.com/ankur02sarkar"><div className="menu-item icon"><AiFillGithub /></div></a>
        </div>
    );
}
